...
For development based on the live API, you should run the front-end as follows:

 $ METACPAN_API=api.beta.metacpan.org twiggy lib/MetaCPAN/Web.pm -p 5001 -R lib -E development
